...
Pycytominer uses [Release Drafter](https://github.com/release-drafter/release-drafter) to prepare GitHub release notes automatically from merged pull requests.
