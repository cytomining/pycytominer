...
The Pycytominer API consists of five key steps applied to the single-cell output (outlined above).
The outputs generated by Pycytominer are subsequently utilized for downstream analysis, which includes machine learning models and statistical testing to derive insights.
