...
Pycytominer can process appropriately structured CellProfiler outputs directly.
We recommend harmonizing CellProfiler outputs with [CytoTable](https://github.com/cytomining/CytoTable) before using Pycytominer for most workflows (e.g., CellProfiler -> CytoTable -> Pycytominer).
