...
The example below demonstrates how to perform normalization using Pycytominer with a dataset generated by [CellProfiler](https://cellprofiler.org/).
...
In some cases, raw morphological features may not be extracted from CellProfiler.
