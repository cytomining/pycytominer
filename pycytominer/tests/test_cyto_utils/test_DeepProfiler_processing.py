...
example_project_dir = os.path.join(
    os.path.dirname(__file__), "..", "test_data", "DeepProfiler_example_data_2"
)
...
test_class = AggregateDeepProfiler(
    index_file=index_file, profile_dir=profile_dir, aggregate_on="well"
)

df = test_class.annotate_deep()
