...
Once you're comfortable with the concepts, see :doc:`walkthrough` for task-focused guides
that assume familiarity with the pipeline and get straight to a more advanced goal.
